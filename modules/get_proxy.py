...
r = requests.get(f'{url1}xyscrape.com/v2/?request=getproxies&protocol=https&timeout=3000&country=all&simplified=true')
proxy_list = re.findall(r'\d+\.\d+\.\d+\.\d+:\d+', r.text)
[all_proxy.append('https://' + i) for i in proxy_list]
good_proxy = []
